 ...
 */
public class DefaultRobotConfiguration extends RobotConfiguration {

  // FIXME: update all CAN IDs and steer offsets
  private static final int FRONT_LEFT_MODULE_DRIVE_MOTOR = 2;
  private static final int FRONT_LEFT_MODULE_STEER_MOTOR = 3;
  private static final int FRONT_LEFT_MODULE_STEER_ENCODER = 10;
  private static final Angle FRONT_LEFT_MODULE_STEER_OFFSET = Rotations.of(0.805908);

  private static final int FRONT_RIGHT_MODULE_DRIVE_MOTOR = 4;
  private static final int FRONT_RIGHT_MODULE_STEER_MOTOR = 5;
  private static final int FRONT_RIGHT_MODULE_STEER_ENCODER = 11;
  private static final Angle FRONT_RIGHT_MODULE_STEER_OFFSET = Rotations.of(0.373535);

  private static final int BACK_LEFT_MODULE_DRIVE_MOTOR = 6;
  private static final int BACK_LEFT_MODULE_STEER_MOTOR = 7;
  private static final int BACK_LEFT_MODULE_STEER_ENCODER = 12;
  private static final Angle BACK_LEFT_MODULE_STEER_OFFSET = Rotations.of(0.510742);

  private static final int BACK_RIGHT_MODULE_DRIVE_MOTOR = 8;
  private static final int BACK_RIGHT_MODULE_STEER_MOTOR = 9;
  private static final int BACK_RIGHT_MODULE_STEER_ENCODER = 13;
  private static final Angle BACK_RIGHT_MODULE_STEER_OFFSET = Rotations.of(0.45652);

  private static final int GYRO_ID = 14;

  // FIXME: update robot dimensions
  private static final Mass MASS = Kilograms.of(51.862); // FIXME: update based on measured mass of robot with battery and bumpers
  ...
  private static final double WHEEL_COEFFICIENT_OF_FRICTION =  1.2; // FIXME: update based on wheel coefficient of friction
  ...
  @Override
  public SwerveModuleConfiguration getSwerveConstants() {
    // FIXME: specify the type of swerve module (MK4 and MK4i are supported)
    return SwerveModuleConfiguration.MK4I_L2_CONSTANTS;
  }
