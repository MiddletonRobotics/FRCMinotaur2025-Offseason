...
public class CompetitionTunerConstants {
    ...
    // All swerve devices must share the same CAN bu3
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.19677734375);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.009765625);
     ...
     */
    public static DrivetrainIOCTRE createDrivetrain() {
        return new DrivetrainIOCTRE(
