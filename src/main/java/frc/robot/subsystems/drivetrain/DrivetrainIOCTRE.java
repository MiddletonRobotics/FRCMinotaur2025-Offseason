...
public class DrivetrainIOCTRE extends SwerveDrivetrain<TalonFX, TalonFX, CANcoder> implements DrivetrainIO {
  ...
  private static final SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> backRight = backModulesConstantCreator.createModuleConstants(
    ...
    public DrivetrainIOCTRE() {
        ...
        //FaultReporter.getInstance().registerHardware(SUBSYSTEM_NAME, "FL Drive", this.getModule(0).getDriveMotor());
        //FaultReporter.getInstance().registerHardware(SUBSYSTEM_NAME, "FL Steer", this.getModule(0).getSteerMotor());
        //FaultReporter.getInstance().registerHardware(SUBSYSTEM_NAME, "FL Encoder", this.getModule(0).getEncoder());
        //FaultReporter.getInstance().registerHardware(SUBSYSTEM_NAME, "FR Drive", this.getModule(1).getDriveMotor());
        //FaultReporter.getInstance().registerHardware(SUBSYSTEM_NAME, "FR Steer", this.getModule(1).getSteerMotor());
        //FaultReporter.getInstance().registerHardware(SUBSYSTEM_NAME, "FR Encoder", this.getModule(1).getEncoder());
        //FaultReporter.getInstance().registerHardware(SUBSYSTEM_NAME, "BL Drive", this.getModule(2).getDriveMotor());
        //FaultReporter.getInstance().registerHardware(SUBSYSTEM_NAME, "BL Steer", this.getModule(2).getSteerMotor());
        //FaultReporter.getInstance().registerHardware(SUBSYSTEM_NAME, "BL Encoder", this.getModule(2).getEncoder());
  ...
  private static ClosedLoopOutputType getSteerClosedLoopOutputType() {
    if (RobotConfiguration.getInstance().getSwerveSteerControlMode()
        == RobotConfiguration.SWERVE_CONTROL_MODE.TORQUE_CURRENT_FOC) {
  ...
  private static ClosedLoopOutputType getDriveClosedLoopOutputType() {
    if (RobotConfiguration.getInstance().getSwerveDriveControlMode()
        == RobotConfiguration.SWERVE_CONTROL_MODE.TORQUE_CURRENT_FOC) {
      return ClosedLoopOutputType.TorqueCurrentFOC;
    } else {
      return ClosedLoopOutputType.Voltage;
