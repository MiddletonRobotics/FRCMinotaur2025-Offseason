...
public abstract class SwerveModuleConfiguration {
    ...
    public static final SwerveModuleConfiguration MK4_L2_CONSTANTS =
    ...
    public static final SwerveModuleConfiguration MK4I_L2_CONSTANTS =
        new SwerveModuleConfiguration() {
          @Override
          public double getDriveGearRatio() {
    ...
    public static final SwerveModuleConfiguration MK4I_L3_CONSTANTS =
        new SwerveModuleConfiguration() {
          @Override
          public double getDriveGearRatio() {
    ...
    public static final SwerveModuleConfiguration MK4I_L3_PLUS_CONSTANTS =
        new SwerveModuleConfiguration() {
          @Override
          public double getDriveGearRatio() {
    ...
    public static final SwerveModuleConfiguration MK4N_L3_PLUS_CONSTANTS =
        new SwerveModuleConfiguration() {
          @Override
          public double getDriveGearRatio() {
    ...
    public static final SwerveModuleConfiguration MK4N_L2_PLUS_CONSTANTS =
        new SwerveModuleConfiguration() {
          @Override
          public double getDriveGearRatio() {
    ...
    /* MK4n L3 Plus */
    private static final double MK4N_L3_PLUS_DRIVE_GEAR_RATIO = 1 / ((16.0 / 50.0) * (28.0 / 16.0) * (15.0 / 45.0));
    ...
    private static final double MK4N_L2_PLUS_DRIVE_GEAR_RATIO =  1 / ((16.0 / 50.0) * (27.0 / 17.0) * (15.0 / 45.0));
    private static final boolean MK4N_L2_PLUS_DRIVE_MOTOR_INVERTED = true;
    private static final double MK4N_L2_PLUS_ANGLE_GEAR_RATIO = 1 / ((16.0 / 50.0) * (10.0 / 60.0)); // same as L3+
    ...
    private static final double MK4I_L3_PLUS_DRIVE_GEAR_RATIO = 1 / ((16.0 / 50.0) * (28.0 / 16.0) * (15.0 / 45.0));
  
    /* MK4i L3 */
  
    private static final double MK4I_L3_DRIVE_GEAR_RATIO = 1 / ((14.0 / 50.0) * (28.0 / 16.0) * (15.0 / 45.0));
    ...
    private static final double MK4I_L2_DRIVE_GEAR_RATIO = 1 / ((14.0 / 50.0) * (27.0 / 17.0) * (15.0 / 45.0));
    ...
    private static final double MK4_L2_DRIVE_GEAR_RATIO = 1 / ((14.0 / 50.0) * (27.0 / 17.0) * (15.0 / 45.0));
