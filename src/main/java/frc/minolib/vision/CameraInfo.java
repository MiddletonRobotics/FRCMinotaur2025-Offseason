 ...
 *
 * <ul>
 *   <li>{@code transform} - The 3D transform representing the camera's position and orientation.
 *   <li>{@code cameraMatrix} - An optional 3x3 matrix representing the camera's intrinsic
 *       parameters.
 *   <li>{@code distCoeffs} - An optional 8x1 matrix representing the camera's distortion
 *       coefficients.
 * </ul>
 *
...
public class CameraInfo {
    ...
    public CameraInfo(final Transform3d transform, final Optional<Matrix<N3, N3>> cameraMatrix, final Optional<Matrix<N8, N1>> distCoeffs) {
