...
public abstract class RobotConfiguration {
  private static RobotConfiguration drivetrainConfiguration;

  public static RobotConfiguration getInstance() {
    return drivetrainConfiguration;
  }

  protected RobotConfiguration() {
    RobotConfiguration.drivetrainConfiguration = this;
  }
   ...
   */
  public abstract SwerveModuleConfiguration getSwerveConstants();
   ...
   */
  public SwerveModuleConfiguration getFrontSwerveConstants() {
   ...
   */
  public SwerveModuleConfiguration getBackSwerveConstants() {
    return getSwerveConstants();
  }
  ...
  public com.pathplanner.lib.config.RobotConfig getPathPlannerRobotConfig() {
    return new com.pathplanner.lib.config.RobotConfig(
        ...
        new ModuleConfig(
            ...
            Amps.of(SwerveModuleConfiguration.DRIVE_PEAK_CURRENT_LIMIT),
            1),
